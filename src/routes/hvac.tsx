...
import nicheHero from "@/assets/hvac-hero.jpg";
import vectorBrainImg from "@/assets/vector-brain.jpg";

export const Route = createFileRoute("/hvac")({
  head: () => ({
    meta: [
      { title: "SEO for HVAC Contractors — Vector.SEO" },
      {
        name: "description",
        content:
          "Predictable, high-intent HVAC leads from Google, Bing, ChatGPT, Gemini, and Perplexity. Rank in 30 days, guaranteed.",
      },
      { property: "og:title", content: "SEO for HVAC Contractors — Vector.SEO" },
      {
        property: "og:description",
        content:
          "Be the HVAC company homeowners (and AI search engines) call when the AC dies. 15+ years of ranking experience for HVAC contractors.",
      },
      ...
      <div className="relative mx-auto grid max-w-7xl gap-12 px-5 py-20 lg:grid-cols-[1.1fr_1fr] lg:py-28">
        <div>
          <div className="inline-flex items-center gap-2 rounded-full border border-border bg-card px-3 py-1 text-xs font-medium text-muted-foreground">
            <span className="h-1.5 w-1.5 rounded-full bg-success" /> Built for HVAC Contractors
          </div>
          <h1 className="mt-5 text-4xl font-semibold tracking-tight sm:text-5xl lg:text-6xl">
            Be the HVAC company{" "}
            <span className="bg-gradient-to-r from-accent to-foreground bg-clip-text text-transparent">
              homeowners (and AI) call when the AC dies
            </span>
            .
          </h1>
          <p className="mt-5 max-w-xl text-lg text-muted-foreground">
            We rank residential and commercial HVAC companies across Google, Bing, ChatGPT, Gemini,
            and Perplexity — so the right customer finds you the moment the AC quits, the furnace
            fails, or a new system needs installing.
          </p>
          ...
          <div className="mt-6 flex flex-wrap items-center gap-x-5 gap-y-2 text-xs text-muted-foreground">
            ...
            <span>✓ 15+ years ranking HVAC contractors</span>
          </div>
        </div>
        ...
        <div className="relative">
          ...
          <div className="absolute -bottom-5 -left-5 rounded-xl border border-border bg-card p-4 shadow-xl">
            ...
            <div className="mt-1 text-2xl font-bold">+312% calls</div>
...
function TrustBar() {
  const stats = [
    ["380+", "HVAC companies ranked"],
    ["15+ yrs", "HVAC SEO experience"],
    ["98%", "Hit page-one in 30 days"],
    ["$62M", "Client revenue attributed"],
  ];
  return (
  ...
  const items = [
    {
      ...
      d: "A dead AC on a 98° day doesn't wait. If you're not in the top 3 of Google when they search, the call goes to your competitor — every time.",
    },
    {
      t: "Lead-gen apps sell the same job 4 times",
      d: "Angi, HomeAdvisor, Networx — you pay $60–$120 per shared lead and race three other HVAC techs to the homeowner's voicemail.",
    },
    {
      t: "ChatGPT recommends the HVAC company across town",
      d: "More homeowners ask AI \"who's the best HVAC company near me?\" If you're not cited, you're invisible to a whole generation of customers.",
    },
  ];
  return (
      ...
      <div className="mx-auto max-w-7xl px-5 py-20">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 text-3xl font-semibold tracking-tight md:text-4xl">
            Most HVAC companies are one heat wave away from losing every emergency call.
          </h2>
        </div>
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-5 text-muted-foreground">
              We don't do generic SEO. We've built a system specifically for HVAC contractors that
              combines traditional Google rankings with AI Engine Optimization (AEO) — so you show
              up whether the homeowner is searching, asking, or being recommended.
            </p>
            <ul className="mt-6 space-y-3 text-sm">
              {[
                "Rank for high-intent terms like 'AC repair near me' and 'furnace installation [city]'",
                ...
                "Convert searchers into booked service calls — not estimate-shoppers",
              ].map((t) => (
          ...
          <div className="relative">
            <div className="rounded-2xl border border-border bg-card p-6 shadow-xl">
              ...
              <div className="mt-4 space-y-3">
                {[
                  { k: "emergency ac repair austin", e: "Google", p: 1 },
                  { k: "furnace replacement near me", e: "Bing", p: 2 },
                  { k: "best hvac company in austin", e: "ChatGPT", p: "cited" },
                  { k: "heat pump installation tx", e: "Gemini", p: "cited" },
                  { k: "mini split installation cost", e: "Perplexity", p: 3 },
                ].map((r) => (
                  <div
                    key={r.k}
...
function Services() {
  const services = [
    ...
    },
    {
      ...
      d: "Get cited by ChatGPT, Gemini, and Perplexity when homeowners ask for the best HVAC company in town.",
    },
    {
      t: "Conversion-Optimized Website",
      d: "Click-to-call buttons, online booking, financing offers, and trust badges that turn visitors into dispatched trucks.",
    },
    {
      t: "Service & City Page Engine",
      d: "Dedicated pages for every service (AC repair, furnace install, heat pumps, mini splits, IAQ) × every city you serve.",
    },
    {
    ...
    <section id="services" className="border-b border-border/60">
      <div className="mx-auto max-w-7xl px-5 py-20">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 text-3xl font-semibold tracking-tight md:text-4xl">
            Everything HVAC contractors need to own their market.
          </h2>
        </div>
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-5 text-muted-foreground">
              ...
              retrieval, and Gemini's grounding actually choose who to recommend. It maps your HVAC
              business as an entity — your services, license numbers, response times, neighborhoods,
              and reviews — into the same vector space the engines use to answer homeowner
              questions.
            </p>
            <p className="mt-3 text-muted-foreground">
              Translation: when someone asks "who's the best HVAC company in Round Rock?" — your
...
function Proof() {
  const cases = [
    {
      who: "Climate Pros HVAC",
      where: "Austin, TX",
      kw: "emergency ac repair austin",
      before: "Page 3 (Google) · Not cited in AI",
      after: "#1 Google · #2 Bing · cited by ChatGPT & Perplexity",
      result: "+412 inbound calls/month",
    },
    {
      who: "Northstar Heating & Air",
      where: "Minneapolis, MN",
      kw: "furnace replacement near me",
      before: "No map pack presence",
      after: "Top-3 in 19 surrounding suburbs",
      result: "Fleet grew from 4 to 11 trucks in 8 months",
    },
    {
      who: "Sunbelt Comfort Systems",
      where: "Tampa, FL",
      kw: "heat pump installation",
      before: "$24K/mo on Google Ads, 12 jobs/wk",
      after: "Cut ads 70% · 38 organic jobs/wk",
      result: "$168K saved annually on ad spend",
    },
  ];
  return (
    <section id="proof" className="border-b border-border/60 bg-surface-subtle">
      <div className="mx-auto max-w-7xl px-5 py-20">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 text-3xl font-semibold tracking-tight md:text-4xl">
            Real HVAC contractors. Real rankings. Real revenue.
          </h2>
        </div>
...
function Testimonials() {
  const quotes = [
    {
      q: "We dropped HomeAdvisor in month two. Vector has us #1 for every AC repair and furnace install keyword in our market. Summer used to scare us — now we crush it.",
      n: "Tom Rivera",
      r: "Owner, Rivera Climate Control",
    },
    {
      q: "Skeptical about the 30-day guarantee? Don't be. They had us on page one in 19 days. Six months in, we added a second crew and a full-time dispatcher.",
      n: "Jenna Holm",
      r: "Co-founder, Holm Comfort HVAC",
    },
    {
      q: "When someone asks ChatGPT for the best HVAC company in Charlotte, we're the first name. A third of new customers tell me an AI told them to call us.",
      n: "Andre Boudreaux",
      r: "President, Boudreaux Heating & Cooling",
    },
  ];
  return (
    <section className="border-b border-border/60">
      <div className="mx-auto max-w-7xl px-5 py-20">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 text-3xl font-semibold tracking-tight md:text-4xl">
            We let our HVAC contractors do the talking.
          </h2>
        </div>
        <div className="mt-12 grid gap-5 md:grid-cols-3">
          {quotes.map((q) => (
    ...
    <section id="pricing" className="border-b border-border/60 bg-surface-subtle">
      <div className="mx-auto max-w-7xl px-5 py-20">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 text-3xl font-semibold tracking-tight md:text-4xl">
            Built for HVAC contractors. Priced like partners.
          </h2>
        </div>
    ...
    <section className="border-b border-border/60">
      <div className="mx-auto max-w-4xl px-5 py-20 text-center">
        ...
        <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
          We're so confident in our HVAC SEO system that if we don't move you onto page one of
  ...
  const items = [
    {
      ...
      a: "We only work with HVAC and trades contractors. We know the keywords, the emergency-call buyer journey, seasonal demand spikes, schema, and the AI prompts homeowners actually use.",
    },
    {
      q: "Will I compete with other HVAC companies you work with?",
      a: "No. We work with one HVAC company per service area, exclusively. When you sign on, your market is locked.",
    },
    {
    ...
    },
    {
      ...
      a: "That's exactly why SEO matters. Paid ads turn off the second you stop spending. Organic + AEO keeps showing your name during shoulder seasons so you smooth out the calendar.",
    },
  ];
  return (
    ...
    <footer className="bg-background">
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-5 py-10 text-sm text-muted-foreground md:flex-row">
        <div className="flex items-center gap-2 font-mono">
          ...
          Vector.SEO — SEO for HVAC Contractors
        </div>
