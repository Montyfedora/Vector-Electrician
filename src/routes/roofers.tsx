...
export const Route = createFileRoute("/roofers")({
  head: () => ({
    meta: [
      { title: "SEO for Roofers — Vector.SEO" },
      {
        name: "description",
        content:
          "Predictable, high-intent roofing leads from Google, Bing, ChatGPT, Gemini, and Perplexity. Rank in 30 days, guaranteed.",
      },
      { property: "og:title", content: "SEO for Roofers — Vector.SEO" },
      {
        property: "og:description",
        content:
          "Be the roofer homeowners (and AI search engines) recommend after the next storm. 15+ years of ranking experience for roofing contractors.",
      },
      { property: "og:image", content: rooferHero },
    ],
  }),
  component: RoofersPage,
});

function RoofersPage() {
  return (
      ...
      <div className="relative mx-auto grid max-w-7xl gap-12 px-5 py-20 lg:grid-cols-[1.1fr_1fr] lg:py-28">
        <div>
          <div className="inline-flex items-center gap-2 rounded-full border border-border bg-card px-3 py-1 text-xs font-medium text-muted-foreground">
            <span className="h-1.5 w-1.5 rounded-full bg-success" /> Built for Roofing Contractors
          </div>
          <h1 className="mt-5 text-4xl font-semibold tracking-tight sm:text-5xl lg:text-6xl">
            Be the roofer{" "}
            <span className="bg-gradient-to-r from-accent to-foreground bg-clip-text text-transparent">
              homeowners call after the storm
            </span>
            .
          </h1>
          <p className="mt-5 max-w-xl text-lg text-muted-foreground">
            We rank residential and commercial roofers across Google, Bing, ChatGPT, Gemini, and
            Perplexity — so when the hail hits, the leak starts, or the insurance check clears, your
            phone is the one that rings.
          </p>
        ...
        <div className="relative">
          ...
          <div className="absolute -bottom-5 -left-5 rounded-xl border border-border bg-card p-4 shadow-xl">
            ...
            <div className="mt-1 text-2xl font-bold">+341% leads</div>
...
function TrustBar() {
  const stats = [
    ["350+", "Roofers ranked"],
    ["15+ yrs", "Roofing SEO experience"],
    ["98%", "Hit page-one in 30 days"],
    ["$71M", "Client revenue attributed"],
  ];
  return (
...
function Problem() {
  const items = [
    {
      t: "Storm-chasers eat your lunch every season",
      d: "Out-of-state crews flood your market after every hail event, outranking you on the keywords that drive insurance claims.",
    },
    {
      t: "Shared lead platforms sell every job 5 times",
      d: "Angi, HomeAdvisor, Roofr — you pay $60–$120 per lead and race four other roofers to the homeowner's voicemail.",
    },
    {
      t: "ChatGPT recommends the other roofer in town",
      d: "More homeowners are asking AI \"who's the most trustworthy roofer near me?\" If you're not cited, you don't get the call.",
    },
  ];
  return (
      ...
      <div className="mx-auto max-w-7xl px-5 py-20">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 text-3xl font-semibold tracking-tight md:text-4xl">
            Most roofers fight for scraps the second the storm passes.
          </h2>
        </div>
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-5 text-muted-foreground">
              We don't do generic SEO. We've built a system specifically for roofing contractors
            ...
            <ul className="mt-6 space-y-3 text-sm">
              {[
                "Rank for high-intent terms like 'roof replacement near me' and 'storm damage roofer [city]'",
                ...
                "Convert searchers into booked inspections — not insurance tire-kickers",
              ].map((t) => (
          ...
          <div className="relative">
            <div className="rounded-2xl border border-border bg-card p-6 shadow-xl">
              ...
              <div className="mt-4 space-y-3">
                {[
                  { k: "roof replacement denver", e: "Google", p: 1 },
                  { k: "storm damage roofer near me", e: "Bing", p: 2 },
                  { k: "best roofing company denver", e: "ChatGPT", p: "cited" },
                  { k: "metal roof install colorado", e: "Gemini", p: "cited" },
                  { k: "hail damage roof inspection", e: "Perplexity", p: 3 },
                ].map((r) => (
                  <div
                    key={r.k}
  ...
  const services = [
    {
      ...
      d: "Rank #1 in the Google Map Pack for every city, ZIP code, and storm-affected neighborhood you serve.",
    },
    {
      t: "AI Engine Optimization",
      d: "Get cited by ChatGPT, Gemini, and Perplexity when homeowners ask for the most trusted roofer in town.",
    },
    {
      t: "Conversion-Optimized Website",
      d: "Project galleries, financing, insurance-claim help, and instant inspection booking that turns lookers into signed contracts.",
    },
    {
      t: "Service & City Page Engine",
      d: "Dedicated pages for every roofing service (asphalt, metal, tile, storm repair) × every city you serve — built to rank.",
    },
    {
      t: "Review & Reputation Engine",
      d: "Automated review requests after every install — because 5-star social proof is the #1 ranking signal for local search.",
    },
    {
      t: "High-Authority Link Building",
      d: "Editorial features in home improvement, insurance, and trade publications that move the rankings needle.",
    },
  ];
  return (
    <section id="services" className="border-b border-border/60">
      <div className="mx-auto max-w-7xl px-5 py-20">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 text-3xl font-semibold tracking-tight md:text-4xl">
            Everything a roofer needs to own their market.
          </h2>
        </div>
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-5 text-muted-foreground">
              ...
              roofing business as an entity — your services, warranties, manufacturer
              certifications, neighborhoods, and reviews — into the same vector space the engines
              use to answer homeowner questions.
            </p>
            <p className="mt-3 text-muted-foreground">
              Translation: when someone asks "who's the best storm damage roofer in Plano?" — your
...
function Process() {
  const steps = [
    ...
    },
    {
      ...
      d: "Service-area pages, storm keywords, review velocity, and link building.",
    },
    {
      n: "04",
      t: "Rank & Scale (Day 30+)",
...
function Proof() {
  const cases = [
    {
      who: "Summit Peak Roofing",
      where: "Denver, CO",
      kw: "storm damage roofer denver",
      before: "Page 3 (Google) · Not cited in AI",
      after: "#1 Google · #1 Bing · cited by ChatGPT & Perplexity",
      result: "+$2.1M in signed roof replacements (hail season)",
    },
    {
      who: "Coastal Shield Roofing",
      where: "Tampa, FL",
      kw: "hurricane roof repair tampa",
      before: "No map pack presence",
      after: "Top-3 in 21 surrounding ZIPs",
      result: "Crews booked 4 months out post-season",
    },
    {
      who: "Northstar Metal Roofs",
      where: "Minneapolis, MN",
      kw: "metal roof installation minneapolis",
      before: "$28K/mo on Google Ads, 9 jobs/mo",
      after: "Cut ads 70% · 31 organic jobs/mo",
      result: "$235K saved annually on ad spend",
    },
  ];
  return (
    <section id="proof" className="border-b border-border/60 bg-surface-subtle">
      <div className="mx-auto max-w-7xl px-5 py-20">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 text-3xl font-semibold tracking-tight md:text-4xl">
            Real roofers. Real rankings. Real revenue.
          </h2>
        </div>
...
function Testimonials() {
  const quotes = [
    {
      q: "We stopped buying shared leads in month two. Vector ranks us #1 for every storm-damage keyword in our region. Last hail season was our biggest year ever.",
      n: "Tyler McAllister",
      r: "Owner, McAllister Roofing",
    },
    {
      q: "Skeptical about the 30-day guarantee? Don't be. They had us on page one in 24. Six months later we added two more crews and a second yard.",
      n: "Angela Pruitt",
      r: "Co-founder, Pruitt Family Roofing",
    },
    {
      q: "When somebody asks ChatGPT for the best roofer in Charlotte, we're the first name. New customers literally tell me an AI told them to call us.",
      n: "Andre Fields",
      r: "President, Fieldstone Roofing Group",
    },
  ];
  return (
    <section className="border-b border-border/60">
      <div className="mx-auto max-w-7xl px-5 py-20">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 text-3xl font-semibold tracking-tight md:text-4xl">
            We let the roofers do the talking.
          </h2>
        </div>
        <div className="mt-12 grid gap-5 md:grid-cols-3">
          {quotes.map((q) => (
    ...
    <section id="pricing" className="border-b border-border/60 bg-surface-subtle">
      <div className="mx-auto max-w-7xl px-5 py-20">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 text-3xl font-semibold tracking-tight md:text-4xl">
            Built for roofers. Priced like partners.
          </h2>
        </div>
    ...
    <section className="border-b border-border/60">
      <div className="mx-auto max-w-4xl px-5 py-20 text-center">
        ...
        <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
          We're so confident in our roofing SEO system that if we don't move you onto page one of
  ...
  const items = [
    {
      ...
      a: "We only work with roofing and trades contractors. We know the keywords, the storm-season buyer journey, insurance-claim language, manufacturer schema, and the AI prompts homeowners actually use.",
    },
    {
      q: "Will I compete with other roofers you work with?",
      a: "No. We work with one roofing company per service area, exclusively. When you sign on, your market is locked.",
    },
    {
      q: "How fast will I see leads?",
      a: "Most clients see first-page rankings within 30 days and a measurable lead lift within 45–60 days. AI engine citations (ChatGPT, Gemini) typically start appearing in week 3–6.",
    },
    {
      q: "Can you help me beat storm-chasers in my market?",
      a: "Yes — that's our specialty. Local authority signals, schema, and AI citations are exactly what out-of-state crews can't fake, and what Google rewards.",
    },
    {
      q: "What if I'm a smaller owner-operator?",
      a: "The Foundations plan is built exactly for that — owner-operators and small crews who want predictable local leads without enterprise overhead.",
    },
  ];
  return (
