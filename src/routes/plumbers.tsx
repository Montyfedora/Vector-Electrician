...
export const Route = createFileRoute("/plumbers")({
  head: () => ({
    meta: [
      { title: "SEO for Plumbers — Vector.SEO" },
      {
        name: "description",
        content:
          "Predictable, high-intent plumbing leads from Google, Bing, ChatGPT, Gemini, and Perplexity. Rank in 30 days, guaranteed.",
      },
      { property: "og:title", content: "SEO for Plumbers — Vector.SEO" },
      {
        property: "og:description",
        content:
          "Be the plumber homeowners (and AI search engines) call first. 15+ years of ranking experience for plumbing contractors.",
      },
      { property: "og:image", content: plumberHero },
    ],
  }),
      ...
      <div className="relative mx-auto grid max-w-7xl gap-12 px-5 py-20 lg:grid-cols-[1.1fr_1fr] lg:py-28">
        <div>
          <div className="inline-flex items-center gap-2 rounded-full border border-border bg-card px-3 py-1 text-xs font-medium text-muted-foreground">
            <span className="h-1.5 w-1.5 rounded-full bg-success" /> Built for Plumbing Contractors
          </div>
          ...
          <p className="mt-5 max-w-xl text-lg text-muted-foreground">
            We rank residential and commercial plumbers across Google, Bing, ChatGPT, Gemini, and
            Perplexity — so the right homeowner finds you the moment the pipe bursts, the water
            heater dies, or the drain backs up.
          </p>
          ...
          <div className="mt-7 flex flex-col gap-3 sm:flex-row">
            ...
            >
              Get My Free Plumbing SEO Audit →
            </a>
            <a
              href="#proof"
        ...
        <div className="relative">
          ...
          <div className="overflow-hidden rounded-2xl border border-border shadow-2xl">
            <img
              src={plumberHero}
              alt="Professional plumber servicing a residential kitchen"
              width={1536}
              height={1024}
          ...
          <div className="absolute -bottom-5 -left-5 rounded-xl border border-border bg-card p-4 shadow-xl">
            ...
            <div className="mt-1 text-2xl font-bold">+287% calls</div>
...
function TrustBar() {
  const stats = [
    ["500+", "Plumbers ranked"],
    ["15+ yrs", "Plumbing SEO experience"],
...
function Problem() {
  const items = [
    {
      t: "Emergency calls go to whoever ranks first",
      d: "A burst pipe doesn't wait. If you're not in the top 3 of Google when they search, the call goes to your competitor — every single time.",
    },
    {
      t: "Lead-gen apps sell the same job 4 times",
      d: "Angi, HomeAdvisor, Thumbtack — you're paying $40–80 per shared lead and racing 3 other plumbers to the phone.",
    },
    {
      t: "ChatGPT recommends the plumber down the street",
      d: "More homeowners are now asking AI \"who's the best plumber near me?\" If you're not cited, you're invisible to a whole generation of customers.",
    },
  ];
  return (
      ...
      <div className="mx-auto max-w-7xl px-5 py-20">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 text-3xl font-semibold tracking-tight md:text-4xl">
            Most plumbers are one Google update away from losing the phone.
          </h2>
        </div>
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-5 text-muted-foreground">
              We don't do generic SEO. We've built a system specifically for plumbing contractors
            ...
            <ul className="mt-6 space-y-3 text-sm">
              {[
                "Rank for emergency terms like 'plumber near me' and 'water heater repair [city]'",
                ...
                "Convert searchers into booked jobs — not price-shoppers",
              ].map((t) => (
          ...
          <div className="relative">
            <div className="rounded-2xl border border-border bg-card p-6 shadow-xl">
              ...
              <div className="mt-4 space-y-3">
                {[
                  { k: "emergency plumber dallas", e: "Google", p: 1 },
                  { k: "water heater repair near me", e: "Bing", p: 2 },
                  { k: "best plumber in dallas", e: "ChatGPT", p: "cited" },
                  { k: "drain cleaning service tx", e: "Gemini", p: "cited" },
                  { k: "tankless water heater install", e: "Perplexity", p: 3 },
                ].map((r) => (
                  <div
                    key={r.k}
  ...
  const services = [
    {
      ...
      d: "Rank #1 in the Google Map Pack for every city, ZIP code, and neighborhood you service — including emergency keywords.",
    },
    {
      t: "AI Engine Optimization",
      d: "Get cited by ChatGPT, Gemini, and Perplexity when homeowners ask for the best plumber in town.",
    },
    {
      t: "Conversion-Optimized Website",
      d: "Click-to-call buttons, online booking, financing options, and trust badges that turn visitors into dispatched trucks.",
    },
    {
      t: "Service & City Page Engine",
      d: "Dedicated pages for every service (drain cleaning, water heaters, repipes) × every city you serve — built to rank.",
    },
    {
    ...
    <section id="services" className="border-b border-border/60">
      <div className="mx-auto max-w-7xl px-5 py-20">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 text-3xl font-semibold tracking-tight md:text-4xl">
            Everything a plumber needs to own their market.
          </h2>
        </div>
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-5 text-muted-foreground">
              ...
              plumbing business as an entity — your services, response times, license numbers,
              neighborhoods, and reviews — into the same vector space the engines use to answer
              homeowner questions.
            </p>
            <p className="mt-3 text-muted-foreground">
              Translation: when someone asks "who's the best emergency plumber in Plano?" — your
...
function Proof() {
  const cases = [
    {
      who: "Apex Drain & Plumbing",
      where: "Dallas, TX",
      kw: "emergency plumber dallas",
      before: "Page 3 (Google) · Not cited in AI",
      after: "#1 Google · #2 Bing · cited by ChatGPT & Perplexity",
      result: "+412 inbound calls/month",
    },
    {
      who: "Brookside Plumbing Co.",
      where: "Kansas City, MO",
      kw: "water heater repair kansas city",
      before: "No map pack presence",
      after: "Top-3 in 18 surrounding suburbs",
      result: "Fleet grew from 4 to 9 trucks in 8 months",
    },
    {
      who: "Tidewater Plumbing",
      where: "Virginia Beach, VA",
      kw: "tankless water heater install",
      before: "$22K/mo on Google Ads, 11 jobs/wk",
      after: "Cut ads 65% · 38 organic jobs/wk",
      result: "$176K saved annually on ad spend",
    },
  ];
  return (
    <section id="proof" className="border-b border-border/60 bg-surface-subtle">
      <div className="mx-auto max-w-7xl px-5 py-20">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 text-3xl font-semibold tracking-tight md:text-4xl">
            Real plumbers. Real rankings. Real revenue.
          </h2>
        </div>
...
function Testimonials() {
  const quotes = [
    {
      q: "We dropped Angi and HomeAdvisor in month two. Vector has us ranking #1 for every emergency plumbing keyword in our market. The phone won't stop ringing.",
      n: "Mike Donovan",
      r: "Owner, Donovan Plumbing",
    },
    {
      q: "I was skeptical about the 30-day guarantee. They had us on page one in 19 days. Six months in we added a second crew and a third truck.",
      n: "Rosa Hernandez",
      r: "Co-founder, RH Plumbing & Heating",
    },
    {
      q: "When someone asks ChatGPT for the best plumber in Tampa, my company is the first name. Half my new customers tell me an AI told them to call.",
      n: "Jamal Brooks",
      r: "President, Bayline Plumbing",
    },
  ];
  return (
    <section className="border-b border-border/60">
      <div className="mx-auto max-w-7xl px-5 py-20">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 text-3xl font-semibold tracking-tight md:text-4xl">
            We let the plumbers do the talking.
          </h2>
        </div>
        <div className="mt-12 grid gap-5 md:grid-cols-3">
          {quotes.map((q) => (
    ...
    <section id="pricing" className="border-b border-border/60 bg-surface-subtle">
      <div className="mx-auto max-w-7xl px-5 py-20">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 text-3xl font-semibold tracking-tight md:text-4xl">
            Built for plumbers. Priced like partners.
          </h2>
        </div>
    ...
    <section className="border-b border-border/60">
      <div className="mx-auto max-w-4xl px-5 py-20 text-center">
        ...
        <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
          We're so confident in our plumbing SEO system that if we don't move you onto page one of
  ...
  const items = [
    {
      ...
      a: "We only work with plumbing and trades contractors. We know the keywords, the emergency-call buyer journey, the seasonality (winter freeze, summer A/C runoff), the schema, and the AI prompts homeowners actually use.",
    },
    {
      q: "Will I compete with other plumbers you work with?",
      a: "No. We work with one plumbing company per service area, exclusively. When you sign on, your market is locked.",
    },
    {
